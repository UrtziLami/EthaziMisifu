...
Public Class ErreserbaSartu
    ...
    Private Sub datuakAldatu()
        ...
        End Try
        Dim erab As String = cmBErab.SelectedText
        Dim ostatu As String = cmBOst.SelectedText
        Dim sartData As String = mCSart.ToString
        Dim irtData As String = mCIrte.ToString
