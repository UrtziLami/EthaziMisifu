<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AldatuOstatua.aspx.vb" Inherits="Misifu_ASP2.AldatuOstatua" %>
...
<body>
    <form id="form1" runat="server">
        <div align="center">
            ...
            <br />
            <br />
            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="32pt" Text="ALDATU OSTATUA"></asp:Label>
            <br />
            <br />
            <br />
        </div>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <asp:Button ID="btnAldatu" runat="server" Height="36px" Text="Aldatu" Width="74px" Enabled="False" />
